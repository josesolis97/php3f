              ...
              <table border="0" cellpadding="0" cellspacing="0" class="table table-bordered">
                ...
                <tr id="dv_filter_3" style="display:none;"  >
                  ...
                  <option value="0" ></option>
                              <?php
					$sqlpais = "select * from seg_perfiles order by perfil asc";
...
if ($_REQUEST['nombre']!='') { $where1=" and (nombre LIKE '%".$_REQUEST['nombre']."%')"; $nombre=$_REQUEST['nombre']; }else{ $where1=''; $nombre=''; }
			
if ($_REQUEST['usuario']!='') { $where2=" and usuario LIKE '%".$_REQUEST['usuario']."%'"; $usuario=$_REQUEST['usuario']; }else{ $where2=''; $usuario='';  }
