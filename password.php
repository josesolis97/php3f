...
if ( isset($_REQUEST['Modificar'])) {
        ...
        extract($_REQUEST);
			...
			$sql="update seg_usuarios set  clave = '$passwd'  where id='$id'";
			...
			<div class="row-fluid sortable">	
				<div class="box span12">
					...
					<div class="box-content">
					  <form class="form-horizontal" name="frm-usuarios" id="frm" method="post" enctype="multipart/form-data" action="password.php">
                        <fieldset>
                        ...
                        <div class="control-group">
                          <label class="control-label" for="focusedInput">Contrase&ntilde;a Nueva  </label><div class="controls">
