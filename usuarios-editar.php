...
if ( isset($_REQUEST['Alta'])) {
       ...
       extract($_REQUEST);
		...
		$sql="Insert into seg_usuarios ( nombre, usuario, clave, perfil, activo, fechaalta  )
				values ('$nombre', '$usuario', '$passwd', '$perfil',  '1', '$alta')";
					...
					<div class="box-content">
                      <form class="form-horizontal" name="frm" id="frm" method="post" action="usuarios-editar.php?action=<?php echo $action ?>">
                        ...
                        <div class="control-group">
                          ...
                          <?php if ($action =='alta') {  ?>
                            <input name="usuario" class="input-xlarge focused" id="focusedInput" type="text" value="<?php echo $row['usuario']; ?>" required="required" />
                          <?php } ?>
